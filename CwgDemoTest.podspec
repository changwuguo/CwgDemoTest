...
Pod::Spec.new do |s|
  s.name             = 'CwgDemoTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CwgDemoTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/changwuguo@qq.com/CwgDemoTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'changwuguo@qq.com' => 'changwuguo@bytedance.com' }
  s.source           = { :git => 'https://github.com/changwuguo@qq.com/CwgDemoTest.git', :tag => s.version.to_s }
